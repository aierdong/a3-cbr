...
const COVERAGE: Record<string, string[]> = {
  ...
  '3.5': ['tests/components/cases/CaseForm.test.ts'],
  ...
  '6.1': ['tests/api/cases.test.ts', 'tests/api/recommendations.test.ts', 'tests/api/feedback.test.ts'],
  '6.2': [
    'tests/components/common/LoadingState.test.ts',
    'tests/components/common/EmptyState.test.ts',
    'tests/components/common/ErrorNotice.test.ts',
  ],
  '6.3': ['tests/api/cases.test.ts', 'tests/api/recommendations.test.ts', 'tests/api/feedback.test.ts'],
